...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #002973;">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="?controller=Cita&&action=mostrar">Mi agenda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?controller=Cita&&action=mostrarPacientes">Pacientes</a>
                </li>
                <li class="nav-item">
